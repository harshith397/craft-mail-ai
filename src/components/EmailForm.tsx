        ...
        <div className="lg:h-full flex flex-col">
          <div className="relative flex-1">
            <Textarea
              ...
              readOnly
              rows={20}
              className="border-2 border-gray-200 rounded-xl px-3 sm:px-4 py-2 sm:py-3 bg-gray-50/90 resize-none pr-10 sm:pr-12 font-georgia text-xs sm:text-sm leading-relaxed tracking-wide h-full min-h-[400px]"
            />
            {generatedEmail && (
              <Button
